...
@AndroidEntryPoint
class AddContractorActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAddContractorBinding
    private lateinit var addContractorUI: AddContractorUI
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddContractorBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        addContractorUI = AddContractorUI(this, binding, ::postAddContractor)
