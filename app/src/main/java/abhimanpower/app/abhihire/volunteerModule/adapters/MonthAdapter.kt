...
class MonthAdapter(context: Context, resource: Int, private val items: List<MonthData>) :
    ArrayAdapter<MonthData>(context, resource, items) {
    ...
    private fun createView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        textView.text = items[position].monthName
