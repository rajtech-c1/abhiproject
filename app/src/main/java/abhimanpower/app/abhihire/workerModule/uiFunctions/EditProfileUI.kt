...
class EditProfileUI(
    context: Context,
    binding: ActivityEditWorkerProfileBinding,
    private val onValuated: (workerData: WorkerData) -> Unit = {},
) {
    private val mBinding: ActivityEditWorkerProfileBinding
...
//        calendar.time = minimumDate
    ...
    private var workCategorySelected = LoginCredentials.workerAccountData.workCategory.toInt()
    ...
    private fun initWorkCategorySpinner() {
        ...
        mBinding.spSelectWorkCategory.setSelection(LoginCredentials.workerAccountData.workCategory.toInt())
    ...
    private fun initStateSpinner(
        ...
        mBinding.spSelectState.setSelection(LoginCredentials.workerAccountData.state.toInt())
    }

    private fun setDistrict() {
        val districtId = LoginCredentials.workerAccountData.district.toInt()
