...
import abhimanpower.app.abhihire.databinding.ActivityRegisterWorkerBinding
...
import abhimanpower.app.abhihire.workerModule.uiFunctions.RegisterWorkerUI
...
class RegisterWorkerActivity : AppCompatActivity() {
    ...
    private lateinit var registerWorkerUI: RegisterWorkerUI
    ...
    private fun initView() {
        registerWorkerUI = RegisterWorkerUI(this, binding, ::postAddWorker)
